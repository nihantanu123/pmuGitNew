...
namespace PMU.PMUService {
    ...
    public interface IPMUService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPMUService/IsUserAuthorized", ReplyAction="http://tempuri.org/IPMUService/IsUserAuthorizedResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(PMU.PMUService.PMUServiceResult), Action="http://tempuri.org/IPMUService/IsUserAuthorizedPMUServiceResultFault", Name="PMUServiceResult", Namespace="http://schemas.datacontract.org/2004/07/PMU.PMUServices.PMUService.Contracts.Enti" +
            "tites")]
        PMU.PMUService.PMUServiceResult IsUserAuthorized(string userName, string password);
    }
    ...
    public partial class PMUServiceClient : System.ServiceModel.ClientBase<PMU.PMUService.IPMUService>, PMU.PMUService.IPMUService {
        ...
        public PMU.PMUService.PMUServiceResult IsUserAuthorized(string userName, string password) {
            return base.Channel.IsUserAuthorized(userName, password);
        }
    }
}
